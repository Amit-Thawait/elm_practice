...
var _user$project$Main$addScore = F3(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'Score':
				return A3(_user$project$Main$addScore, model, _p3._0, _p3._1);
			case 'Edit':
				var _p4 = _p3._0;
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$playLi = function (play) {
	return A2(
...
var _user$project$Main$playList = function (model) {
	return A2(
		...
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Main$playLi, model.plays));
};
...
var _user$project$Main$playerLi = F2(
	function (editPlayerID, player) {
		return A2(
			_elm_lang$html$Html$li,
			{ctor: '[]'},
...
var _user$project$Main$playerList = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$playerLi(model.playerID),
			A2(
